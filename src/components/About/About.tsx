...
const About = ({ headingAs: Tag = 'h2' }: Props) => {
  return (
          ...
          <div className="row justify-content-center" style={{ margin: '0 auto' }}>
            <div className="col-lg-8" data-aos="fade-up" suppressHydrationWarning style={{ margin: '0 auto' }}>
              <div className="about-content" style={{ textAlign: 'center', margin: '0 auto', paddingLeft: '0' }}>
                <Tag style={{ color: '#fff', fontSize: 'clamp(2rem, 4vw, 2.5rem)', fontWeight: '800', marginBottom: '30px', lineHeight: '1.3' }}>
                ...
                <p style={{ color: '#fff', fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '30px' }}>
                  With flexible scheduling, customized cleaning plans, and competitive rates, we adapt to your lifestyle and budget. Trust us to maintain the highest standards of cleanliness and hygiene in your space.
                </p>
